...
public class Tc_004_SignInWithEmail extends BaseSpiceJet {
	public class Tc_004_SignIn extends BaseSpiceJet {
		...
		public void setup() {
			...
			testAuthor = "Sindhuja";
			sheetName="signInwithEmail";
		}
		@Test(dataProvider="getFromExcel")
		public void signInwithMobile(String email,String password) {
			HomePage hp=new HomePage();
			hp.loginButton();
			
			 SignInPage sp = new SignInPage(); 
			 sp.signInWithMobileNumber(email,password);
